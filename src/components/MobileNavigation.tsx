        ...
        <div className="container mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <motion.button
              ...
              className={`md:hidden p-2 ${textColor} z-50 relative`}
                  ...
                  <div className="pl-4 space-y-1">
                    ...
                    >
                      <Link
                        to="/studio"
                        onClick={handleLinkClick}
                        className={`block py-3 px-4 ${textColorSecondary} hover:${textColor.split('-')[1]} hover:bg-purple-500/10 rounded-lg transition-colors`}
                      >
                        New Edge Studio
                      </Link>
                    </motion.div>
                    ...
                    >
                      <Link
                        to="/media"
                        onClick={handleLinkClick}
                        className={`block py-3 px-4 ${textColorSecondary} hover:${textColor.split('-')[1]} hover:bg-blue-500/10 rounded-lg transition-colors`}
                      >
                        New Edge Media
                      </Link>
                    </motion.div>
                    ...
                    >
                      <Link
                        to="/lab"
                        onClick={handleLinkClick}
                        className={`block py-3 px-4 ${textColorSecondary} hover:${textColor.split('-')[1]} hover:bg-yellow-500/10 rounded-lg transition-colors`}
                      >
                        New Edge Lab
                      </Link>
                    </motion.div>
