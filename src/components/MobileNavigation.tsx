          ...
          <div className="flex items-center gap-7">
            ...
            <div className="relative group/comp">
              <button className="flex items-center">
                <NavHoverItem>
                  {nav.company.trigger}
                  <ChevronDown className="w-3.5 h-3.5 opacity-60 group-hover/comp:rotate-180 transition-transform duration-300" />
                </NavHoverItem>
              </button>
            ...
            >
              ...
              <div className="flex-1 px-6 py-6 overflow-y-auto">
                <nav className="flex flex-col gap-5">
                  ...
                  {/* ─── Company flach — große Direkt-Links im Vertical-Menu-Stil ─── */}
                  <MenuVertical
                    menuItems={nav.company.links.map((l) => ({ label: l.label, href: l.to }))}
