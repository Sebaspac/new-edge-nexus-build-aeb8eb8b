            ...
            <div style={{ height: "64px", marginBottom: "20px", display: "flex", alignItems: "flex-end" }}>
              <AnimatePresence mode="wait">
                {item.Icon ? (
                  ...
                  >
                    <item.Icon style={{ color: VIOLET, width: "22px", height: "22px" }} strokeWidth={1.5} />
                  </motion.div>
                ) : (
    ...
    {(["Unser Prozess", "Warum NEWEDGE"] as Phase[]).map((phase) => (
      <div key={phase} style={{ marginBottom: "3rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "2rem" }}>
          ...
          <span style={{ ...MONO, fontSize: "11px", letterSpacing: "0.22em", textTransform: "uppercase" as const, color: VIOLET }}>
            {phase}
          </span>
        </div>
              ...
              >
                <div>
                  {item.Icon ? (
                    ...
                    >
                      <item.Icon style={{ color: VIOLET, width: "16px", height: "16px" }} strokeWidth={1.5} />
                    </div>
                  ) : (
                    <span
                      style={{
