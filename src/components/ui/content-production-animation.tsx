      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute -inset-8 sm:-inset-12 rounded-full border-2 border-dashed border-blue-400/40"
          />
          ...
          <motion.div
            ...
            className="absolute -inset-5 sm:-inset-8 rounded-full border border-cyan-400/50"
          />
