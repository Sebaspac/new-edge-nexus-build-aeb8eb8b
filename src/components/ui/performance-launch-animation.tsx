    ...
    <div className="relative w-full h-[350px] md:h-[400px] lg:h-[500px] bg-gradient-to-br from-blue-950/90 via-cyan-900/80 to-blue-900/90 rounded-3xl overflow-hidden border border-blue-500/30">
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        ...
        {[...Array(6)].map((_, idx) => (
          <motion.div
            key={idx}
            initial={{ y: 40, opacity: 0, x: (idx - 2.5) * 15 }}
            animate={{
              y: [-20, -60],
              opacity: [0, 1, 0],
            }}
        ...
        <motion.div
          ...
          className="absolute -inset-14 rounded-full border-2 border-dashed border-blue-400/30"
        />
        <motion.div
          animate={{ rotate: -360 }}
        ...
        {/* Graph Lines */}
        <svg className="absolute -inset-12 w-24 h-24" style={{ left: '-48px', top: '-48px' }}>
          <motion.path
            d="M 12 80 Q 30 70 48 50 T 84 20"
            fill="none"
            stroke="#22d3ee"
            strokeWidth="2"
            strokeLinecap="round"
            ...
            {launchPhase >= 2 && (
              ...
              >
                <motion.div
                  ...
                  className="w-4 bg-gradient-to-b from-cyan-400 via-blue-500 to-transparent rounded-b-full"
                  style={{ height: 12 }}
                />
              </motion.div>
            )}
        ...
        >
          <motion.div
            ...
            className="flex items-center gap-1 bg-green-500/20 border border-green-500/30 rounded-full px-2 py-1"
          >
            <TrendingUp className="w-3 h-3 text-green-400" />
            <span className="text-[10px] text-green-300 font-bold">+127%</span>
          </motion.div>
        </motion.div>
      </div>
