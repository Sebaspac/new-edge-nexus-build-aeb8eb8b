...
export const SalesChaosAnimation = () => {
  ...
  return (
    <div className="relative w-full h-full min-h-[350px] md:min-h-[400px] lg:min-h-[500px] bg-gradient-to-br from-red-950/20 via-background to-orange-950/20 overflow-hidden">
