  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-10 h-10 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-purple-500 via-blue-500 to-teal-500 animate-pulse flex items-center justify-center z-10">
            <div className="absolute w-14 h-14 md:w-20 md:h-20 rounded-full border border-white/20 animate-ping opacity-70"></div>
            <div
              className="absolute w-16 h-16 md:w-24 md:h-24 rounded-full border border-white/10 animate-ping opacity-50"
              style={{ animationDelay: "0.5s" }}
            ></div>
            <div className="w-5 h-5 md:w-8 md:h-8 rounded-full bg-white/80 backdrop-blur-md"></div>
          </div>

          <div className="absolute w-52 h-52 md:w-96 md:h-96 rounded-full border border-white/10"></div>
          ...
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Mobile Detail Card - Fixed at bottom */}
                {isExpanded && (
                  <div 
                    className="md:hidden fixed bottom-4 left-4 right-4 z-[300]"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <Card className="w-full bg-black/95 border-white/30 shadow-xl shadow-white/10" style={{ WebkitBackdropFilter: 'blur(16px)', backdropFilter: 'blur(16px)' }}>
                      ...
                      <CardContent className="p-3 pt-0 text-[11px] text-white/80">
                ...
                {/* Desktop Detail Card - Relative to node */}
                {isExpanded && (
                  <Card className="hidden md:block absolute top-20 left-1/2 w-64 bg-black/90 border-white/30 shadow-xl shadow-white/10 overflow-visible" style={{ WebkitBackdropFilter: 'blur(16px)', backdropFilter: 'blur(16px)', transform: 'translate3d(-50%, 0, 0)' }}>
