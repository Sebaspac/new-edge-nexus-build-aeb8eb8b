      ...
      <div className="container-xl">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          duration: 0.6
            ...
            <p className="text-lg text-muted-foreground leading-relaxed font-normal lg:text-xl">Unser Creative-Tech-Team vereint Strategie-Know-how und Praxiserfahrung, um maßgeschneiderte Kreativ- und Automationslösungen, die auf die spezifischen Bedürfnisse und Herausforderungen Ihres Unternehmens zugeschnitten sind.</p>
          </motion.div>
