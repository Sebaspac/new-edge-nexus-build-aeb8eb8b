...
const CortexIcon = ({ still }: IconProps) => (
  <motion.svg viewBox="0 0 120 110" width="120" height="110" fill="none" strokeLinecap="round"
    ...
    <motion.rect x="32" y="27" width="56" height="56" rx="12" stroke={LAVENDER} strokeWidth="1.5"
    ...
    {/* mittlere Raute */}
    <rect x="40" y="35" width="40" height="40" rx="10" stroke={LAVENDER} strokeWidth="2"
      style={{ transformOrigin: "60px 55px", transformBox: "view-box", transform: "rotate(45deg)" }} />
    {/* innerer Kern */}
    <rect x="49" y="44" width="22" height="22" rx="7" fill="rgba(167,139,250,0.18)" stroke={LAVENDER} strokeWidth="1.5"
      style={{ transformOrigin: "60px 55px", transformBox: "view-box", transform: "rotate(45deg)" }} />
...
const OwnershipIcon = ({ still }: IconProps) => (
  <svg viewBox="0 0 120 110" width="120" height="110" fill="none" strokeLinecap="round" strokeLinejoin="round">
    ...
    <motion.polygon points="60,22 92,40 92,70 60,88 28,70 28,40"
      fill="#241638" stroke="rgba(132,118,239,0.5)" strokeWidth="1.5"
      style={{ transformOrigin: "60px 55px", transformBox: "view-box" }}
      animate={still ? {} : { rotate: [-2, 2, -2] }}
      transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }} />
    {/* Glow hinter dem Slot */}
    <motion.rect x="46" y="48" width="28" height="14" rx="2" fill={VIOLET_GLOW}
...
const Chevron = ({ i, still }: { i: number; still: boolean }) => (
  <div className="ne-chevron" aria-hidden>
    <motion.svg width="14" height="20" viewBox="0 0 14 20" fill="none"
      ...
      <polyline points="3,3 11,10 3,17" stroke={VIOLET} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </motion.svg>
  </div>
);
  ...
  return (
    ...
    >
      ...
      <div aria-hidden style={{
        position: "absolute", inset: 0, pointerEvents: "none",
        background:
          "radial-gradient(ellipse 50% 50% at 0% 0%, rgba(132,118,239,0.07) 0%, transparent 60%), radial-gradient(ellipse 50% 50% at 100% 100%, rgba(34,211,238,0.05) 0%, transparent 60%)",
      }} />
