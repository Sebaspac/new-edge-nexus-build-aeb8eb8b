...
const content: Record<StateType, ContentState> = {
  ...
  fusion: {
    ...
    description:
      "Im Lab setzen wir KI und Softwareentwicklung so um, dass daraus echte, funktionierende Produkte entstehen.",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        >
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 max-w-4xl">
            ...
            realisiert über ein Headquarter-Modell.  Mit einer Vision: Ihre Marke in der Digital Welt zu postionieren
            und 
          </p>
