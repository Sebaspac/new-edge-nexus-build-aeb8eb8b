          ...
          >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div
                  className="absolute top-1/2 right-1/4 -translate-y-1/2 translate-x-1/4 w-[600px] h-[600px] rounded-full blur-[120px] opacity-40"
                    ...
                    <div className="absolute inset-0">
                      <div className="grid grid-cols-8 grid-rows-8 w-full h-full gap-4 p-12">
                        {[...Array(64)].map((_, i) => (
                          <motion.div
                            key={i}
                            className="bg-pink-500/15 border border-pink-400/25 rounded"
                            animate={{
                              opacity: [0.1, 0.6, 0.1],
                            }}
                            transition={{
                  ...
                  {activeState === "fusion" && (
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                      {[...Array(3)].map((_, i) => (
                        ...
                        >
                          <div
                            className="w-32 h-32 rounded-full border-2 border-purple-400/40"
                            style={{
