      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <motion.div
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 max-w-xl mt-4 sm:mt-6">Unsere Arbeit folgt deshalb einer klaren Reihenfolge: Klarheit im Studio. Umsetzung im Lab.</p>
