                ...
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 mt-6 pt-6 border-t border-gray-700">
                    <Button
                      onClick={acceptNecessary}
                      variant="outline"
                      className="border-gray-500/50 text-gray-300 hover:bg-gray-500/10 flex-1"
                    >
                      Nur Notwendige
                    </Button>
                    <Button
                      onClick={savePreferences}
                      className="bg-gradient-to-r from-purple-600 to-blue-600 text-white hover:from-purple-700 hover:to-blue-700 flex-1"
                    >
                      Auswahl speichern
                    </Button>
                    <Button
                      onClick={acceptAll}
                      className="bg-gradient-to-r from-green-600 to-green-700 text-white hover:from-green-700 hover:to-green-800 flex-1"
                    >
                      Alle akzeptieren
                    </Button>
                  </div>
