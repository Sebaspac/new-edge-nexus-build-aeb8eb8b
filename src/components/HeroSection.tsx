...
const CyberneticGridShader = lazy(() => import("./ui/cybernetic-grid-shader"));

interface HeroSectionProps {
  onContactClick: () => void;
}

// Minimal gradient fallback while shader loads
const ShaderFallback = () => (
  <div className="absolute inset-0 bg-black">
    <div 
      className="absolute inset-0"
      style={{
        background: 'linear-gradient(135deg, rgba(124, 58, 237, 0.05) 0%, transparent 50%, rgba(88, 28, 135, 0.03) 100%)',
      }}
    />
  </div>
);
