...
const translations = {
  de: {
    ...
    'home.hero.description': 'Wir helfen Marken, sichtbar zu werden, Prozesse zu automatisieren – und den Wandel durch Innovation aktiv zu gestalten.',
    ...
    'services.hero.description': 'Umfassende digitale Lösungen, die Strategie, Design und Technologie nahtlos verbinden. Wir entwickeln maßgeschneiderte Ansätze für Ihre einzigartigen Herausforderungen.',
    ...
    'studio.hero.description': 'Unser kreatives Zentrum, wo Ideen Form annehmen. Hier entstehen innovative Designs und durchdachte Benutzererfahrungen, die Ihre Marke zum Leben erwecken.',
    ...
    'lab.hero.description': 'Unser Experimentierfeld für cutting-edge Technologien. Hier erforschen wir die Zukunft der digitalen Innovation und entwickeln bahnbrechende Lösungen.',
    ...
    'lab.blockchain.description': 'Dezentrale Anwendungen und Smart Contracts für die nächste Generation des Internets.',
    ...
    'lab.agentHub.description': 'Revolutionäre KI-Agenten, die komplexe Aufgaben autonom bewältigen und Ihr Unternehmen in die Zukunft führen.',
    ...
    'lab.smartAnalytics.description': 'Automatisierte Datenanalyse und Erkenntnisgewinnung für datengetriebene Entscheidungen.',
  ...
  en: {
    ...
    'home.hero.description': 'We develop digital solutions that go beyond the ordinary. From strategic consulting to cutting-edge technology - we bring your vision to life.',
    'home.about.title': 'About Us',
    'home.about.description': 'New Edge is a creative tech studio specializing in innovative digital solutions. We connect strategic thinking with aesthetic design and cutting-edge technology.',
    ...
    'services.hero.title': 'NEW EDGE SERVICES',
    'services.hero.subtitle': 'For strategy. aesthetics. & tech.',
    'services.hero.description': 'Comprehensive digital solutions that seamlessly connect strategy, design, and technology. We develop tailored approaches for your unique challenges.',
    'services.keyActivities': 'Key Activities',
    'services.strategy.title': 'Strategic Consulting',
    ...
    'media.hero.title': 'NEW EDGE MEDIA',
    'media.hero.subtitle': 'For strategy. aesthetics. & tech.',
    'media.hero.description': 'Creative media production that tells stories and awakens emotions. From concept to final implementation - we bring your vision to life.',
    'media.services.title': 'Media Services',
    'media.video.title': 'Video Production',
    ...
    'studio.hero.title': 'NEW EDGE STUDIO',
    'studio.hero.subtitle': 'For strategy. aesthetics. & tech.',
    'studio.hero.description': 'Our creative center where ideas take shape. Here we create innovative designs and thoughtful user experiences that bring your brand to life.',
    'studio.services.title': 'Studio Services',
    'studio.ux.title': 'UX/UI Design',
    ...
    'lab.hero.title': 'NEW EDGE LAB',
    'lab.hero.subtitle': 'For strategy. aesthetics. & tech.',
    'lab.hero.description': 'Our experimentation field for cutting-edge technologies. Here we explore the future of digital innovation and develop groundbreaking solutions.',
    'lab.services.title': 'Lab Services',
    'lab.ai.title': 'AI Solutions',
    'lab.ai.description': 'Intelligent automation and AI-powered solutions for complex challenges.',
    'lab.blockchain.title': 'Blockchain Development',
    'lab.blockchain.description': 'Decentralized applications and smart contracts for the next generation of the internet.',
    'lab.ar.title': 'AR/VR Experiences',
    ...
    'lab.agentHub.description': 'Revolutionary AI agents that autonomously handle complex tasks and lead your business into the future.',
    'lab.featured.title': 'Featured Applications',
    'lab.upcoming.title': 'Upcoming Applications',
    'lab.smartAnalytics.title': 'Smart Analytics Agent',
