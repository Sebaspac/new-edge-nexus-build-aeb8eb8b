                ...
                <div className="relative">
                  ...
                  <div className="space-y-24 relative z-10">
                    ...
                    ease: "easeOut"
                      ...
                      {/* Central Journey Node */}
                      <motion.div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full border-2 sm:border-4 border-white shadow-2xl flex items-center justify-center relative z-20 mx-auto lg:mx-0 aspect-square" initial={{
                      scale: 0,
                      opacity: 0
                    }} whileInView={{
                      scale: 1,
              ...
              transition: {
                ...
                <Card className="h-full bg-white border-border hover:border-primary/50 backdrop-blur-sm transition-all duration-200 hover:shadow-lg">
                  <CardContent className="p-4 md:p-8 flex flex-row md:flex-col items-start md:items-stretch gap-4 md:gap-0 h-full">
                    ...
                    <div className={`w-14 h-14 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-gradient-to-br ${service.gradient} flex items-center justify-center md:mb-6 shadow-lg flex-shrink-0 transition-transform duration-200 hover:scale-105`}>
        ...
        <div className="container-xl relative z-10">
          ...
          duration: 0.8
            ...
            duration: 0.6
              ...
              New Edge ist das Headquarter für Innovation. Wir bauen Marken und automatisieren ihre Arbeit – Strategie,
              Content und Workflows aus einem System.
              <br />
            </motion.p>
