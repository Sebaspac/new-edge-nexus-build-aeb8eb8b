        ...
        y: y2
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-3 gap-12 lg:gap-8">
              ...
              >
                <Card className="bg-transparent border-2 border-purple-500 hover:border-purple-400 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/20 h-full">
                  <CardContent className="p-8 text-center h-full flex flex-col justify-between">
                    <div>
                      <div className="w-16 h-16 mx-auto bg-purple-500/20 border-2 border-purple-400 rounded-full flex items-center justify-center mb-6 backdrop-blur-sm">
                        <Palette className="w-8 h-8 text-purple-400" />
                      </div>
                      <h3 className="text-xl font-bold text-white mb-4">New Edge Studio</h3>
                      <p className="text-gray-300 text-sm mb-6 leading-relaxed">
                        Ihre Ideen, unsere Strategie. Wir entwickeln die visuelle Identität und das Fundament für Ihr Projekt.
                      </p>
                    </div>
                    <Button className="bg-white/10 backdrop-blur-sm text-white border border-white/20 hover:bg-white/15 w-full" asChild>
                      <Link to="/studio">
              ...
              <motion.div 
                ...
                className="relative group"
              >
                <Card className="bg-transparent border-2 border-blue-500 hover:border-blue-400 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/20 h-full">
                  <CardContent className="p-8 text-center h-full flex flex-col justify-between">
                    <div>
                      <div className="w-16 h-16 mx-auto bg-blue-500/20 border-2 border-blue-400 rounded-full flex items-center justify-center mb-6 backdrop-blur-sm">
                        <Video className="w-8 h-8 text-blue-400" />
                      </div>
                      <h3 className="text-xl font-bold text-white mb-4">New Edge Media</h3>
                      <p className="text-gray-300 text-sm mb-6 leading-relaxed">
                        Die perfekte Bühne für Ihre Marke. Content-Produktion und Reichweite wird hier gesteuert.
                      </p>
                    </div>
                    <Button className="bg-white/10 backdrop-blur-sm text-white border border-white/20 hover:bg-white/15 w-full" asChild>
                      <Link to="/media">
              ...
              <motion.div 
                ...
                className="relative group"
              >
                <Card className="bg-transparent border-2 border-yellow-500 hover:border-yellow-400 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-yellow-500/20 h-full">
                  <CardContent className="p-8 text-center h-full flex flex-col justify-between">
                    <div>
                      <div className="w-16 h-16 mx-auto bg-yellow-500/20 border-2 border-yellow-400 rounded-full flex items-center justify-center mb-6 backdrop-blur-sm">
                        <Cpu className="w-8 h-8 text-yellow-400" />
                      </div>
                      <h3 className="text-xl font-bold text-white mb-4">New Edge Lab</h3>
                      <p className="text-gray-300 text-sm mb-6 leading-relaxed">
                        Die perfekte Schnittstelle für Strategie & Technologie. Backend, KI und technische Umsetzung.
                      </p>
                    </div>
                    <Button className="bg-white/10 backdrop-blur-sm text-white border border-white/20 hover:bg-white/15 w-full" asChild>
                      <Link to="/lab">
