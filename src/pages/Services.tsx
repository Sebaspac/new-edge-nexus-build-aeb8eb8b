                ...
                <div className="relative">
                  ...
                  <div className="space-y-24 relative z-10">
                    ...
                    >
                      ...
                      {/* Central Journey Node */}
                      <motion.div
                        className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-full border-2 sm:border-4 border-white shadow-2xl flex items-center justify-center relative z-20 mx-auto lg:mx-0 aspect-square"
                        initial={{
                          scale: 0,
                          opacity: 0,
                        }}
              ...
              <DisplayCards
                cards={[
                  ...
                  },
                  {
                    ...
                    className:
                      "[grid-area:stack] translate-x-32 translate-y-20 hover:-translate-y-4 shadow-lg hover:shadow-2xl border-secondary/30",
                  },
                ]}
              />
            </motion.div>
      ...
      >
        <div className="container-xl relative z-10">
          ...
          >
            ...
            >
              New Edge ist das Headquarter für Innovation. Hier entsteht die Zukunft von Marken, Agenturen und Prozessen
              <br />
            </motion.p>
