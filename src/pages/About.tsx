...
const About = () => {
  ...
  return <>
      ...
      <div className="min-h-screen bg-background">
        ...
        {/* Intro Section - Like Studio Page */}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            ...
            >
              <motion.div
                ...
                className="mb-6"
              >
                <h2 className="text-[36px] sm:text-[48px] md:text-[52px] lg:text-[56px] font-black mb-3 leading-[1.2] text-foreground">
                  THE HEADQUARTERS{" "}
                  <motion.span
                    className="inline-block bg-clip-text text-transparent bg-gradient-primary"
                ...
                <motion.p
                  ...
                  className="text-sm text-muted-foreground mt-4 leading-[1.6] max-w-3xl sm:text-xl"
                >
