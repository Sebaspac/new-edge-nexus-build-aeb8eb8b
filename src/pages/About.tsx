      ...
      <div className="min-h-screen bg-background">
        ...
        <section id="netzwerk" className="relative py-12 sm:py-16 md:section-padding bg-surface overflow-hidden">
          ...
          <div className="container-xl relative z-10">
            ...
            <motion.div
              className="grid md:grid-cols-3 gap-4 sm:gap-5 md:gap-6 max-w-5xl mx-auto"
              initial="hidden"
              whileInView="visible"
              viewport={{
                once: true,
                ...
                >
                  <Card className="h-full bg-gradient-to-br from-background via-surface to-background border-border/50 hover:border-primary/50 backdrop-blur-sm transition-all duration-500 hover:shadow-2xl hover:shadow-primary/20 overflow-hidden">
                    ...
                    <CardContent className="p-5 md:p-7 flex flex-col h-full relative z-10">
                      {/* Animated Icon */}
                      <motion.div
                        className={`w-12 h-12 md:w-16 md:h-16 mb-5 rounded-2xl bg-gradient-to-br ${item.gradient} p-3 shadow-lg relative overflow-hidden`}
                        whileHover={{
                          scale: 1.1,
                          rotate: [0, -10, 10, -10, 0],
                        }}
                      ...
                      <div className="relative mt-auto">
                        <div
                          className={`absolute inset-0 bg-gradient-to-r ${item.gradient} rounded-full opacity-20 group-hover:opacity-40 transition-opacity blur-sm`}
                        />
                        <div className="relative bg-surface/80 backdrop-blur-sm border border-border/50 rounded-full px-4 py-2">
                          <p className="text-xs md:text-sm text-foreground font-semibold text-center">{item.team}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
