  ...
  return <>
      ...
      <div className="min-h-screen bg-background">
        ...
        >
          <div className="container-xl py-4">
            <div className="flex items-center justify-between">
              <div className="text-h3 font-bold bg-gradient-primary bg-clip-text text-transparent">
                NEW EDGE
              </div>
        ...
        <section id="intro" className="relative section-padding bg-background">
          ...
          <div className="container-xl relative z-10">
            ...
            >
              ...
              <motion.p
                className="text-body-xl text-muted-foreground mb-12 leading-relaxed"
                initial={{ opacity: 0 }}
              ...
              >
                ...
                <Button 
                  size="lg"
                  variant="outline"
                  onClick={() => scrollToSection('netzwerk')}
                >
          ...
          <div className="container-xl relative z-10">
            ...
            >
              <div className="relative aspect-square max-w-2xl mx-auto">
                {/* Central Hub */}
                <motion.div
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 rounded-full bg-gradient-primary flex items-center justify-center shadow-2xl z-10"
                  animate={{ 
                    boxShadow: [
                  ...
                  {i % 2 === 0 ? (
                    <>
                      ...
                      <div className="relative flex items-center">
                        <motion.div
                          className="absolute left-0 w-4 h-4 rounded-full bg-primary border-4 border-background shadow-lg"
                    ...
                    <>
                      <div className="relative flex items-center justify-end">
                        <motion.div
                          className="absolute right-0 w-4 h-4 rounded-full bg-secondary border-4 border-background shadow-lg"
                          whileInView={{ scale: [0, 1.2, 1] }}
                          transition={{ duration: 0.5 }}
                        />
                      </div>
        ...
        <section id="netzwerk" className="relative section-padding bg-surface overflow-hidden">
          <motion.div className="absolute top-10 left-10 w-52 h-52 bg-primary/5 rounded-full blur-3xl" 
            animate={{
              x: [0, 40, 0],
              y: [0, -30, 0],
              scale: [1, 1.3, 1],
          ...
          />
          <motion.div className="absolute bottom-10 right-10 w-60 h-60 bg-secondary/5 rounded-full blur-3xl" 
            animate={{
              x: [0, -40, 0],
              y: [0, 30, 0],
              scale: [1.3, 1, 1.3],
                ...
                >
                  <Card className="h-full hover:shadow-xl transition-all duration-300 hover:border-primary/30 group">
                    <CardContent className="p-8 text-center">
                      <motion.div
                        className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-primary p-4 shadow-lg"
