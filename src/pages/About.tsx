          ...
          <div className="container-xl relative z-10">
            ...
            <motion.div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto" initial="hidden" whileInView="visible" viewport={{
              ...
              {[{
                ...
                <motion.div key={founder.name} variants={{
                  hidden: {
                    opacity: 0,
                    y: 80,
                      ...
                      <div className="text-center flex-grow flex flex-col justify-between relative z-10">
                        ...
                        <div className="flex justify-center gap-3 flex-wrap">
                          {founder.expertise.map((skill, skillIndex) => 
                            <motion.span key={skillIndex} className="px-5 py-3 bg-gradient-to-br from-primary/10 to-secondary/10 text-foreground rounded-2xl text-sm font-bold border-2 border-primary/20 shadow-lg hover:shadow-xl" whileHover={{
                              scale: 1.1,
                              y: -5,
