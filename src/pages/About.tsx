        ...
        <section className="relative py-12 sm:py-16 md:section-padding bg-gradient-to-br from-white via-gray-50/30 to-white overflow-hidden">
          ...
          <div className="container-xl relative z-10">
            ...
            once: true
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground max-w-3xl leading-[1.5] text-left">Expertise aus Strategie und Technologie – vereint für Ihren Erfolg.</p>
            </motion.div>
