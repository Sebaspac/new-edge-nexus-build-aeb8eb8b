                  ...
                  <Card className="h-full bg-white border-border hover:border-primary/50 backdrop-blur-sm transition-all duration-500 hover:shadow-xl">
                    ...
                    transition: {
                      ...
                      <div className="flex-grow">
                        <h3 className="text-lg mb-3 md:mb-4 text-foreground font-semibold md:text-2xl">{unit.title}</h3>
                        <p className="text-sm md:text-base text-muted-foreground mb-4 md:mb-6 leading-relaxed">
                          {unit.description}
                        </p>
                      </div>
                      <Button variant="default" onClick={() => window.location.href = unit.link} className="group/btn w-full md:w-auto bg-transparent backdrop-blur-sm border-2 border-black text-black hover:bg-black hover:text-white rounded-none transition-all duration-300">
                        {unit.title} ansehen
