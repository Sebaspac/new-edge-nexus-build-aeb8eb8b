  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <section
          id="modell"
          className="relative py-12 sm:py-16 md:section-padding bg-background overflow-hidden"
        ></section>
              ...
              >
                ...
                <div className="space-y-3 sm:space-y-4 md:space-y-6 text-sm sm:text-base md:text-lg text-muted-foreground leading-relaxed">
                  <p>
                    ...
                    <strong className="text-foreground">strategischer Tech-Partner für nachhaltige Entwicklung</strong>,
                    steuerbare Systeme, klare Entscheidungslogik und skalierbare Plattformen.
                  </p>

                  <p>
                    Von Umsetzung zu Steuerbarkeit. wir verbinden Strategie und Technologie zu einem System, das Sie
                    verstehen, kontrollieren und weiterentwickeln können.
                  </p>
                </div>
                    ...
                    <CardContent className="p-4 sm:p-6 md:p-8 flex flex-col items-center text-center">
                      ...
                      <div className="flex gap-1.5 sm:gap-2 flex-wrap justify-center">
                        {founder.tags.map((tag) => (
                          <span
                            key={tag}
                            className="px-2.5 sm:px-3 md:px-4 py-1 sm:py-1.5 bg-gray-100 text-gray-700 rounded-none text-xs sm:text-sm border border-gray-200 hover:border-primary/50 hover:bg-gray-50 transition-colors"
                          >
                            {tag}
                          </span>
                        ))}
