      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="pt-24 lg:pt-32 px-4 lg:px-8 pb-16 lg:pb-24">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black text-black mb-10 lg:mb-14">Blog – KI & Automatisierung Insights</h1>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-5 space-y-0 divide-y divide-gray-200">
                <div className="text-sm font-semibold uppercase tracking-wider pb-4 mb-0 text-primary">
                  Weitere Artikel
                </div>
        ...
        <div className="text-center py-10 border-t border-gray-100">
          <a href="tel:+4917660431467" style={{ fontFamily: "Consolas, monospace", fontSize: "11px", letterSpacing: "0.16em", color: "rgba(26,10,46,0.38)", textDecoration: "none", borderBottom: "1px solid rgba(26,10,46,0.14)", paddingBottom: "1px" }}>
            ↗ +49 176 60 431 467
          </a>
        </div>
