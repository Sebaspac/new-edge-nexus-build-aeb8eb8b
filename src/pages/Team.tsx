...
const Team = () => {
  ...
  const networkStats = [
    { icon: Users, label: "Coaches", value: "10", color: "text-purple-500" },
    { icon: Code, label: "Entwickler", value: "2", color: "text-blue-500" },
    { icon: Palette, label: "Creative Agencies", value: "3", color: "text-pink-500" },
    { icon: Globe, label: "Länder", value: "4", color: "text-green-500" },
    { icon: Briefcase, label: "Freelancer", value: "15", color: "text-orange-500" }
  ];
          ...
          <div className="container mx-auto px-6">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-black mb-4">
                Die <span className="text-purple-600">Geschäftsführung</span>
              </h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Strategische Visionäre mit einer Mission: Ihre Marke digital zum Leben erwecken
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
              {founders.map((founder, index) => (
                ...
                >
                  <Card className="overflow-hidden border-none shadow-2xl bg-gradient-to-br from-white to-gray-50">
                    <CardContent className="p-8">
                      <div className="aspect-square mb-6 overflow-hidden rounded-2xl bg-gradient-to-br from-purple-100 to-blue-100">
                        <LazyImage
                          src={founder.image}
                          alt={founder.name}
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Vertrauen Sie auf bewährte Expertise – diese Marken setzen bereits auf uns
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <motion.div
                  animate={contactClick ? { scale: 0.95 } : { scale: 1 }}
