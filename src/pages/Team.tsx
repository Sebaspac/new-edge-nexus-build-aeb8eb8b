        ...
        <section className="py-20 px-6">
          <div className="max-w-7xl mx-auto">
            <motion.h2 
              ...
              viewport={{ once: true }}
              className="text-3xl md:text-5xl font-semibold text-center mb-16 text-gray-900"
            >
              Die Gründer
            </motion.h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {founders.map((founder, index) => (
                <motion.div
                  ...
                  className="group"
                >
                  <Card className="p-8 border-0 bg-gray-50/80 backdrop-blur-sm rounded-3xl hover:bg-gray-100/80 transition-all duration-300">
                    <div className="flex flex-col items-center text-center">
                      <div className="w-32 h-32 rounded-full overflow-hidden mb-6 bg-gradient-to-br from-blue-100 to-purple-100">
                        <LazyImage
                          src={founder.image}
                          alt={founder.name}
                      ...
                      <p className="text-gray-600 leading-relaxed mb-6 font-light">{founder.bio}</p>
                      <div className="flex flex-wrap gap-2 justify-center">
                        {founder.expertise.map((skill) => (
                          <Badge 
                            key={skill} 
                            variant="secondary"
                            className="bg-white/70 text-gray-700 border-0 px-3 py-1 rounded-full font-medium"
                          >
                            {skill}
                          </Badge>
                        ))}
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6 max-w-4xl mx-auto">
              {clients.map((client, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.4, delay: index * 0.05 }}
                  className="bg-white rounded-xl p-6 border border-gray-100 flex items-center justify-center min-h-[80px] hover:shadow-sm transition-all duration-300"
                >
            ...
            >
              ...
              >
                <Button 
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 text-lg rounded-full border-0 font-medium shadow-lg hover:shadow-xl transition-all duration-300"
                >
