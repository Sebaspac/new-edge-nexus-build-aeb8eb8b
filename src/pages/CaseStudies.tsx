  ...
  return <motion.section ref={sectionRef} initial={{
    ...
    delay: index * 0.2
      ...
      <div className="relative">
        <div className="flex gap-4 md:gap-6 overflow-x-auto snap-x snap-mandatory 
                     scrollbar-hide px-4 sm:px-6 lg:px-8 pb-4" style={{
        scrollbarWidth: 'none',
        msOverflowStyle: 'none'
          ...
          {cases.map((caseStudy, caseIndex) => <motion.div key={caseStudy.id} initial={{
          opacity: 0,
          x: 50
        }} animate={isInView ? {
          opacity: 1,
          ...
          duration: 0.6,
          delay: index * 0.2 + 0.3 + caseIndex * 0.15
        }} className="flex-shrink-0 snap-start">
              <Link to={caseStudy.route} className="block group">
                <div className="relative overflow-hidden rounded-2xl w-[85vw] sm:w-[70vw] md:w-[500px] lg:w-[550px]" style={{
              aspectRatio: '16/9'
            }}>
                  {/* Background Image */}
                  <img src={caseStudy.image} alt={caseStudy.headline} className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 ease-out group-hover:scale-110" loading="lazy" />
                ...
                background: `linear-gradient(135deg, ${gradientFrom}dd, ${gradientTo}dd)`
                  ...
                  <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-end">
                    {/* Category Tag */}
                    <motion.span className="inline-block self-start border border-white/40 px-3 py-1 text-[10px] md:text-xs font-bold text-white/80 uppercase tracking-wider mb-3 md:mb-4 backdrop-blur-sm">
                      {caseStudy.category}
                    </motion.span>
                  ...
                  {/* Decorative Line */}
                  <div className="absolute bottom-0 left-0 h-1 w-0 group-hover:w-full transition-all duration-500" style={{
                background: `linear-gradient(90deg, ${gradientFrom}, ${gradientTo})`
              }} />
                </div>
              </Link>
...
const CaseStudies = () => {
  ...
  return <>
      ...
      <div className="min-h-screen bg-black">
        ...
        {/* STUDIO Section */}
        <CategorySection title="STUDIO" subtitle="Brand Strategy & Identity" cases={studioCases} accentColor="#7C3AED" gradientFrom="#7C3AED" gradientTo="#A855F7" index={0} />

        {/* MEDIA Section */}
        <CategorySection title="MEDIA" subtitle="Content & Performance" cases={mediaCases} accentColor="#06B6D4" gradientFrom="#06B6D4" gradientTo="#0EA5E9" index={1} />

        {/* LAB Section */}
        <CategorySection title="LAB" subtitle="AI Automation & Innovation" cases={labCases} accentColor="#F59E0B" gradientFrom="#F59E0B" gradientTo="#EF4444" index={2} />
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl text-center">
            ...
            duration: 0.6
              ...
              <button onClick={scrollToContact} className="inline-flex items-center gap-2 bg-white text-black px-6 py-3 md:px-8 md:py-4 rounded-full font-semibold hover:bg-gray-200 transition-colors duration-300">
                Projekt starten
