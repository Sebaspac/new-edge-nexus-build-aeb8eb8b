...
const Lab = () => {
  ...
  useEffect(() => {
    ...
    // Intersection Observer for KI-Agents section
    const agentsSection = document.querySelector('#ki-agents-section');
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          setShowAgents(true);
          startAgentPresentation();
        }
      },
      { threshold: 0.3 }
    );
    ...
    return () => {
      ...
      if (agentsSection) observer.unobserve(agentsSection);
    };
  }, []);

  const startAgentPresentation = () => {
    const agentTimings = [0, 2000, 4000, 6000, 8000]; // 2s intervals
    
    agentTimings.forEach((delay, index) => {
      setTimeout(() => {
        setActiveAgent(index);
        // Move robot across screen for each agent
        setRobotPosition({ x: -100, y: 50 + (index * 20) });
        setTimeout(() => {
          setRobotPosition({ x: window.innerWidth + 100, y: 50 + (index * 20) });
        }, 100);
      }, delay);
    });
  };
  ...
  return <div className="min-h-screen bg-white">
      ...
      <section className="py-16 sm:py-32 bg-gradient-to-br from-white via-gray-50 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          {/* Interactive AI Agents Presentation */}
          <div id="ki-agents-section" className="relative">
            {/* Moving Robot Animation */}
            {showAgents && (
              <div 
                className="fixed top-1/2 z-50 transition-all duration-[3000ms] ease-out pointer-events-none"
                style={{
              ...
              >
                <div className="relative">
                  <div className="w-16 h-16 bg-gradient-to-r from-primary to-accent rounded-full flex items-center justify-center animate-bounce shadow-lg">
                    <Bot className="w-10 h-10 text-white animate-pulse" />
                  </div>
                  <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-black text-white px-3 py-1 rounded-full text-xs font-semibold whitespace-nowrap">
                    Agent {activeAgent + 1} präsentiert!
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="transition-all duration-1000 opacity-100 translate-y-0 scale-100">
                <div className="group cursor-pointer max-w-4xl mx-auto">
                  <div className="relative overflow-hidden bg-gradient-to-br from-white via-gray-50 to-white border-0 shadow-xl hover:shadow-2xl rounded-2xl transition-all duration-500 hover:scale-[1.02]">
                    ...
                    <div className="absolute -top-4 left-8 bg-primary text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg z-10">
                      Agent #1
                    </div>
                    
                    <div className="relative p-8 sm:p-10 grid lg:grid-cols-2 gap-8 items-center">
                      <div>
                        <div className="flex items-start gap-6 mb-8">
                          ...
                          <div className="flex-1">
                            <h3 className="text-3xl sm:text-4xl font-bold text-black mb-4 group-hover:text-primary transition-colors">
                              RAG Agent
                            </h3>
                        ...
                        <div className="space-y-4 mb-8">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-base font-medium text-gray-800">Sofort Zugriff auf aktualisiertes Expertenwissen ohne manuellen Aufwand</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <div className="w-3 h-3 rounded-full bg-primary animate-pulse" />
                            <span className="text-base font-medium text-gray-800">Spart Ihrem Team wertvolle Stunden bei der Informationssuche</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <div className="w-3 h-3 rounded-full bg-primary animate-pulse" />
                            <span className="text-base font-medium text-gray-800">Erstellt auf Knopfdruck Marktanalysen oder Trendüberblicke</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        {/* Testimonial */}
                        <div className="bg-gradient-to-r from-primary/5 to-primary/10 rounded-xl p-8 border-l-4 border-primary">
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">Geschäftsführerin, Muster GmbH</p>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="transition-all duration-1000 delay-300 opacity-100 translate-y-0 scale-100">
                <div className="group cursor-pointer max-w-4xl mx-auto">
                  <div className="relative overflow-hidden bg-gradient-to-br from-white via-gray-50 to-white border-0 shadow-xl hover:shadow-2xl rounded-2xl transition-all duration-500 hover:scale-[1.02]">
                    ...
                    {/* Agent Introduction Badge */}
                    <div className="absolute -top-4 right-8 bg-secondary text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg z-10">
                      Agent #2
                    </div>
                    ...
                    <div className="relative p-8 sm:p-10 grid lg:grid-cols-2 gap-8 items-center">
                      <div className="lg:order-2">
                        <div className="flex items-start gap-6 mb-8">
                          ...
                          <div className="flex-1">
                            <h3 className="text-3xl sm:text-4xl font-bold text-black mb-4 group-hover:text-secondary transition-colors">
                              Lead Gen Agent
                            </h3>
                        ...
                        <div className="space-y-4 mb-8">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-base font-medium text-gray-800">Ein stetiger Strom neuer, qualifizierter Leads ohne Mehraufwand im Vertrieb</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <div className="w-3 h-3 rounded-full bg-secondary animate-pulse" />
                            <span className="text-base font-medium text-gray-800">Höhere Abschlussraten durch personalisierte Ansprachen</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <div className="w-3 h-3 rounded-full bg-secondary animate-pulse" />
                            <span className="text-base font-medium text-gray-800">Scannt das Internet nach Branchen-News und generiert warme Leads</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="lg:order-1">
                        {/* Testimonial */}
                        <div className="bg-gradient-to-r from-secondary/5 to-secondary/10 rounded-xl p-8 border-l-4 border-secondary">
                          <p className="text-gray-700 italic mb-4 text-lg leading-relaxed">
                            "Mit dem Lead Gen Agent konnten wir unsere Abschlussrate verdoppeln und die Kontaktpflege vereinfachen!"
                          </p>
                          <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-full bg-secondary/20 flex items-center justify-center">
                              <span className="text-secondary font-bold">MM</span>
                            </div>
                            <div>
                              <p className="font-semibold">Max Mustermann</p>
                              <p className="text-sm text-gray-600">Vertriebsleiter, Beispiel AG</p>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="transition-all duration-1000 delay-500 opacity-100 translate-y-0 scale-100">
                <div className="group cursor-pointer max-w-4xl mx-auto">
                  <div className="relative overflow-hidden bg-gradient-to-br from-white via-gray-50 to-white border-0 shadow-xl hover:shadow-2xl rounded-2xl transition-all duration-500 hover:scale-[1.02]">
                    ...
                    {/* Agent Introduction Badge */}
                    <div className="absolute -top-4 left-8 bg-accent text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg z-10">
                      Agent #3
                    </div>
                    ...
                    <div className="relative p-8 sm:p-10 grid lg:grid-cols-2 gap-8 items-center">
                      <div>
                        <div className="flex items-start gap-6 mb-8">
                          ...
                          <div className="flex-1">
                            <h3 className="text-3xl sm:text-4xl font-bold text-black mb-4 group-hover:text-accent transition-colors">
                              Content Agent
                            </h3>
                        ...
                        <div className="space-y-4 mb-8">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-base font-medium text-gray-800">Regelmäßig frische Inhalte, ohne dass Sie einen Texter beauftragen müssen</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <div className="w-3 h-3 rounded-full bg-accent animate-pulse" />
                            <span className="text-base font-medium text-gray-800">Steigert Ihre Online-Sichtbarkeit und stärkt die Markenbindung</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <div className="w-3 h-3 rounded-full bg-accent animate-pulse" />
                            <span className="text-base font-medium text-gray-800">Schreibt redaktionelle Artikel oder Social-Posts für sofortige Veröffentlichung</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        {/* Testimonial */}
                        <div className="bg-gradient-to-r from-accent/5 to-accent/10 rounded-xl p-8 border-l-4 border-accent">
                          <p className="text-gray-700 italic mb-4 text-lg leading-relaxed">
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">Marketingmanagerin, Innovativ GmbH</p>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="transition-all duration-1000 delay-700 opacity-100 translate-y-0 scale-100">
                <div className="group cursor-pointer max-w-4xl mx-auto">
                  <div className="relative overflow-hidden bg-gradient-to-br from-white via-gray-50 to-white border-0 shadow-xl hover:shadow-2xl rounded-2xl transition-all duration-500 hover:scale-[1.02]">
                    ...
                    {/* Agent Introduction Badge */}
                    <div className="absolute -top-4 right-8 bg-yellow-500 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg z-10">
                      Agent #4
                    </div>
                    ...
                    <div className="relative p-8 sm:p-10 grid lg:grid-cols-2 gap-8 items-center">
                      <div className="lg:order-2">
                        <div className="flex items-start gap-6 mb-8">
                          ...
                          <div className="flex-1">
                            <h3 className="text-3xl sm:text-4xl font-bold text-black mb-4 group-hover:text-yellow-600 transition-colors">
                              Voice Agent
                            </h3>
                        ...
                        <div className="space-y-4 mb-8">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-base font-medium text-gray-800">Rund-um-die-Uhr-Erreichbarkeit ohne zusätzlichen Personalaufwand</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <div className="w-3 h-3 rounded-full bg-yellow-500 animate-pulse" />
                            <span className="text-base font-medium text-gray-800">Freundliche, effiziente Kundenkommunikation – sogar außerhalb der Geschäftszeiten</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <div className="w-3 h-3 rounded-full bg-yellow-500 animate-pulse" />
                            <span className="text-base font-medium text-gray-800">Bucht selbstständig Termine oder beantwortet häufige Kundenfragen per Telefon</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="lg:order-1">
                        {/* Testimonial */}
                        <div className="bg-gradient-to-r from-yellow-400/5 to-yellow-400/10 rounded-xl p-8 border-l-4 border-yellow-400">
                          <p className="text-gray-700 italic mb-4 text-lg leading-relaxed">
                            "Der Voice Agent hat unseren Kundenservice erweitert – jetzt gehen keine Anrufe mehr verloren."
                          </p>
                          <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-full bg-yellow-400/20 flex items-center justify-center">
                              <span className="text-yellow-600 font-bold">PB</span>
                            </div>
                            <div>
                              <p className="font-semibold">Petra Becker</p>
                              <p className="text-sm text-gray-600">Inhaberin, Service24</p>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="transition-all duration-1000 delay-1000 opacity-100 translate-y-0 scale-100">
                <div className="group cursor-pointer max-w-4xl mx-auto">
                  <div className="relative overflow-hidden bg-gradient-to-br from-white via-gray-50 to-white border-0 shadow-xl hover:shadow-2xl rounded-2xl transition-all duration-500 hover:scale-[1.02]">
                    ...
                    {/* Agent Introduction Badge */}
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-blue-500 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg z-10">
                      Agent #5
                    </div>
                    
                    <div className="relative p-8 sm:p-10 text-center">
                      <div className="flex items-center justify-center gap-6 mb-8">
                        <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 shadow-lg shadow-blue-500/25 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                          <Bot className="w-12 h-12 text-white drop-shadow-sm" />
                        </div>
                        <div>
                          <h3 className="text-3xl sm:text-4xl font-bold text-black mb-4 group-hover:text-blue-600 transition-colors">
                            Website Chatbot
                          </h3>
                      ...
                      <p className="text-gray-700 leading-relaxed mb-8 text-lg max-w-3xl mx-auto">
                      ...
                      <div className="grid md:grid-cols-3 gap-6 mb-8">
                        <div className="flex flex-col items-center gap-3 p-4 bg-blue-50 rounded-xl">
                          ...
                          <span className="text-base font-medium text-gray-800 text-center">24/7 Verfügbarkeit ohne Personalkosten</span>
                        </div>
                        <div className="flex flex-col items-center gap-3 p-4 bg-blue-50 rounded-xl">
                          <div className="w-4 h-4 rounded-full bg-blue-500 animate-pulse" />
                          <span className="text-base font-medium text-gray-800 text-center">Sofortige Antworten steigern Conversion-Rate</span>
                        </div>
                        <div className="flex flex-col items-center gap-3 p-4 bg-blue-50 rounded-xl">
                          <div className="w-4 h-4 rounded-full bg-blue-500 animate-pulse" />
                          <span className="text-base font-medium text-gray-800 text-center">Sammelt automatisch Kontaktdaten</span>
                        </div>
                      </div>
                      
                      {/* Testimonial */}
                      <div className="bg-gradient-to-r from-blue-500/5 to-blue-500/10 rounded-xl p-8 border-l-4 border-blue-500 max-w-2xl mx-auto">
                        <p className="text-gray-700 italic mb-4 text-lg leading-relaxed">
                        ...
                        <div className="flex items-center justify-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">Geschäftsführer, Digital Solutions</p>
                          </div>
                        </div>
                      </div>
                    </div>
