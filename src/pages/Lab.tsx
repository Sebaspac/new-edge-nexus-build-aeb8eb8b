...
const Lab = () => {
  ...
  const labServices = [{
    ...
    details: ["Workflow-Analyse und Optimierung", "Automatisierungs-Audit & Strategische Roadmap", "Chatbot- und LLM-Integration"],
    icon: Cpu,
        ...
        <section className="py-16 sm:py-24 bg-gradient-to-br from-white via-yellow-50/30 to-orange-50/30 relative overflow-hidden">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            ...
            duration: 0.6
              ...
              <p className="text-base sm:text-lg lg:text-xl max-w-3xl text-gray-700 leading-relaxed">In unseren Projekten arbeiten KI-Agenten Seite an Seite mit Menschen – sie automatisieren Workflows, koordinieren Systeme und beschleunigen ganze Prozesse.
Jetzt können Sie sie kennenlernen – und erleben, wie intelligente Automatisierung in der Praxis funktioniert.</p>
            </motion.div>
