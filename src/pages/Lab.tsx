  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="NEW EDGE LAB entwickelt innovative KI-Lösungen und maßgeschneiderte Webanwendungen. Von Prozessautomatisierung bis Analytics - Technologie für Ihren Erfolg."
        />
        <meta
          name="keywords"
          content="KI Entwicklung, Webentwicklung, Prozessautomatisierung, KI Agenten, Analytics, Tech Innovation"
        />
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            ...
            >
              ...
              >
                ...
                >
                  LAB entwickelt, automatisiert und skaliert Technologielösungen. Von KI-Integration bis zur
                  vollständigen Webentwicklung.
                </motion.p>
              </motion.div>
            </motion.div>
          </div>
                    ...
                    >
                      ...
                      <ul className="text-sm sm:text-base text-gray-700 leading-relaxed space-y-3">
                        {service.details.map((detail, idx) => (
                          ...
                          >
                            <span
                              className={`flex-shrink-0 w-7 h-7 rounded-full bg-gradient-to-r ${service.gradient} text-white flex items-center justify-center text-sm font-bold`}
                            >
                              {idx + 1}
                            </span>
        ...
        <section className="py-16 sm:py-24 bg-gradient-to-br from-white via-yellow-50/30 to-orange-50/30 relative overflow-hidden">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            ...
            >
              <Button
                size="lg"
                className="bg-white border-2 border-[#fde047] text-black px-12 py-6 rounded-xl font-bold text-lg shadow-xl transition-all duration-300 hover:bg-[#fde047] hover:scale-105"
        ...
        {/* CTA Section */}
        <section
          className="py-12 sm:py-16 text-black relative overflow-hidden"
          style={{
