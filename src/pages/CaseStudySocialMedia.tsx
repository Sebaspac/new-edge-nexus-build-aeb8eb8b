...
const CaseStudySocialMedia = () => {
  ...
  const phases = [{
    ...
    description: "Den Grundstein für intelligente Vertriebsautomation legen. In dieser initialen Phase analysieren wir CRM-Daten und entwickeln ein KI-gestütztes Lead-Scoring-System.",
    features: [{
      icon: Database,
      title: "CRM-Audit",
    ...
    description: "Aufbau der Kommunikations-Assets und Templates. Wir erstellen personalisierte E-Mail-Sequenzen und LinkedIn-Strategien.",
    features: [{
      icon: Mail,
    ...
    description: "Aktivierung und kontinuierliche Optimierung. Wir implementieren den Sales-Agent und richten automatisierte Booking-Workflows ein.",
    features: [{
      icon: Target,
