          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            ...
            <div className="flex items-end justify-between mb-4 md:mb-8">
              ...
              delay: 0.2
                ...
                <Link to="/case-studies" className="inline-flex items-center gap-2 text-sm lg:text-lg font-bold text-black hover:text-[#3b82f6] transition-colors duration-300">
                  ALLE CASES
