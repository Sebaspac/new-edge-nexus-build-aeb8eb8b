        ...
        <section className="py-8 md:py-12 lg:py-16 px-4 md:px-8 lg:px-16 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-3 md:gap-4 mb-4 md:mb-8">
              ...
              <Button variant="outline" className="self-start md:self-auto border-2 border-foreground hover:bg-foreground hover:text-background transition-all duration-300 text-xs md:text-sm" onClick={() => navigate("/case-studies")}>
            ...
            <div className="flex gap-0 overflow-x-auto snap-x snap-mandatory scrollbar-hide md:grid md:grid-cols-2 lg:grid-cols-3">
              {mediaCases.map((caseItem, index) => <motion.div key={index} initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
              ...
              duration: 0.5,
              delay: index * 0.1
            }} onClick={() => navigate(caseItem.route)} className="group cursor-pointer flex-shrink-0 w-[65%] snap-start md:w-auto">
                  <div className="relative aspect-square overflow-hidden">
                    <img src={caseItem.image} alt={caseItem.headline} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
