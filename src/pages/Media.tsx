      ...
      <div className="min-h-screen bg-white">
                ...
                <div className="bg-white/80 p-6 rounded-xl border border-gray-200">
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      "Creative Asset Paket (Reels, Ads, Web Assets)",
                ...
                <div className="bg-white/80 p-6 rounded-xl border border-gray-200">
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      "KPI-Analyse & monatliches Reporting",
                      "Creator & Influencer Kooperationen"
                    ].map((item, idx) => (
                      <li key={idx} className="flex items-center gap-3">
        ...
        <section className="py-16 sm:py-24 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            ...
            >
              <h2 className="text-2xl sm:text-3xl font-bold text-black mb-4">Unser Prozess</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Clarity, Flow und Conversion — so arbeiten wir mit Ihnen zusammen.
              </p>
            </motion.div>

            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { step: "01", title: "Outcome First", desc: "Was bekommt die Marke wirklich?" },
                { step: "02", title: "Approach / Method", desc: "Wie arbeitet Media? (Creative + Social + Performance)" },
                { step: "03", title: "Deliverables", desc: "Konkrete, greifbare Ergebnisse." },
                { step: "04", title: "Timeline", desc: "3–6 Wochen — klarer Erwartungsrahmen." },
                { step: "05", title: "Investment", desc: "Ab 2.500 € / Kampagne" },
                { step: "06", title: "Case Snippets", desc: "Vorher/Nachher, KPIs, Creatives, Community-Wachstum." }
              ].map((item, idx) => (
                <motion.div
                  key={idx}
                  ...
                  className="bg-white p-6 rounded-xl border border-gray-200 hover:border-[#3b82f6]/30 hover:shadow-lg transition-all duration-200"
                >
                  <span className="text-4xl font-black bg-gradient-to-r from-[#3b82f6] to-[#06b6d4] bg-clip-text text-transparent">
                    {item.step}
                  </span>
                  <h3 className="text-lg font-bold text-black mt-3 mb-2">{item.title}</h3>
        ...
        <section className="py-16 sm:py-24 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            ...
            >
              ...
              <Link 
                to="/case-studies" 
                className="hidden sm:flex items-center gap-2 text-[#3b82f6] hover:text-[#06b6d4] transition-colors font-medium"
              >
            ...
            <Link 
              to="/case-studies" 
              className="sm:hidden flex items-center justify-center gap-2 text-[#3b82f6] hover:text-[#06b6d4] transition-colors font-medium mt-8"
            >
              Alle Cases <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
            ...
            >
              ...
              <Button 
                ...
                size="lg" 
                className="bg-white hover:bg-gray-50 text-[#3b82f6] text-lg px-10 py-4 hover:scale-[1.02] transition-all duration-200"
