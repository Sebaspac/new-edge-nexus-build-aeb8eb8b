...
const CaseStudyRetailLab = () => {
  ...
  const phases = [{
    ...
    description: "Analyse der Datenlandschaft und Definition der Wissensarchitektur. Entwicklung eines maßgeschneiderten RAG-Frameworks.",
    features: [{
      icon: Target,
    ...
    description: "Aufbereitung und Indexierung der Unternehmensdaten für optimale KI-Abfragen.",
    features: [{
      icon: Database,
    ...
    description: "Entwicklung des Chat-Agents mit Rollenrechten und Integration in bestehende Systeme.",
    features: [{
      icon: MessageSquare,
