                ...
                <form onSubmit={handleSubmit} className="space-y-2.5">
                  ...
                  {formStatus && (
                    <motion.div
                      ...
                      style={{
                        fontFamily: OUTFIT,
                        background: formStatus.type === "success" ? "rgba(34,197,94,0.1)" : "rgba(220,38,38,0.08)",
                        color: formStatus.type === "success" ? "#15803d" : "#b91c1c",
                        border: `1px solid ${formStatus.type === "success" ? "rgba(34,197,94,0.25)" : "rgba(220,38,38,0.2)"}`,
                      }}
                    >
