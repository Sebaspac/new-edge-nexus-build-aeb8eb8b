...
const Index = () => {
  ...
  const services = [{
    ...
    description: "Kreative Basis Ihrer Marke: Positionierung, Tonalität, Erscheinungsbild – übersetzt in Kampagnen & Designsysteme.",
        ...
        <section className="relative py-8 sm:py-12 bg-gradient-to-br from-white via-gray-50/30 to-white overflow-hidden">
          <div className="container-xl relative z-10">
            ...
            duration: 0.8
              ...
              <motion.p className="text-body-lg text-muted-foreground max-w-3xl font-normal text-xl">New Edge verbindet Unternehmen und Agenturen in einem exklusiven Netzwerk, um kreative Exzellenz und intelligente Automatisierung zu vereinen.</motion.p>
            </motion.div>
                ...
                ease: [0.25, 0.1, 0.25, 1]
                  ...
                  <div className="bg-white rounded-2xl sm:rounded-[32px] p-6 sm:p-10 md:p-12 lg:p-16 shadow-[0_2px_16px_rgba(0,0,0,0.06)]">
                    <div className="max-w-3xl">
                      ...
                      delay: 0.2,
                      duration: 0.6
                    }} className="text-2xl sm:text-3xl md:text-4xl mb-4 sm:mb-6 text-gray-900 tracking-tight leading-[1.1] font-medium lg:text-4xl">Für Unternehmen, die zukunftsorientiert denken</motion.h3>
                      <motion.p initial={{
                      opacity: 0,
                      y: 10
                    }} animate={{
        ...
        <section className="relative py-8 sm:py-12 bg-gradient-to-br from-gray-50 to-white overflow-hidden">
          <div className="container-xl relative z-10">
            ...
            ease: [0.25, 0.46, 0.45, 0.94]
              ...
              delay: 0.3,
              duration: 0.7
            }} className="text-lg text-muted-foreground leading-relaxed font-normal lg:text-xl max-w-3xl mt-6">Gemeinsam mit Ihrem Team und bestehenden Agenturpartnern entwickeln wir kreative und KI-gestützte Automationslösungen, die Marke, Content und Prozesse nahtlos verbinden.</motion.p>
            </motion.div>
