            ...
            <Tabs defaultValue="kmu" className="w-full">
              <div className="flex justify-center mb-8">
                <TabsList className="inline-flex p-0.5 bg-muted/50 rounded-full border border-border/50 h-9">
                  <TabsTrigger
                    value="kmu"
                    className="text-sm font-medium data-[state=active]:bg-primary data-[state=active]:text-primary-foreground rounded-full transition-all duration-200 px-6"
                  >
                    KMU
                  </TabsTrigger>
                  <TabsTrigger
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        {[
                          ...
                          },
                          {
                            ...
                            description:
                              "New Edge koordiniert Prozesse und Partner zentral – ein Ansprechpartner, klare Ergebnisse.",
                            icon: "🔗",
                          ...
                          },
                          {
                            ...
                            description:
                              "Alle KPIs in Echtzeit: Fortschritt, Performance und ROI jederzeit nachvollziehbar.",
                            icon: "📊",
                        ...
                        {[
                          {
                            ...
                            description:
                              "Agenturprozesse kennen wir aus erster Hand. Wir optimieren Ihre Abläufe – von Briefings bis Reporting – für maximale Effizienz.",
                          ...
                          },
                          {
                            ...
                            description:
                              "Unsere Technologie läuft im Hintergrund – Sie treten als Anbieter smarter Automatisierung auf.",
