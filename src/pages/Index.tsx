          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
            ...
            duration: 0.8
              ...
              duration: 0.6
                ...
                <Button size="lg" onClick={() => setIsContactSheetOpen(true)} className="group bg-black/10 backdrop-blur-md text-black border-2 border-black hover:bg-black hover:text-white transition-all duration-300 text-base md:text-lg px-6 md:px-8 py-4 md:py-6 font-semibold w-full sm:w-auto hover:-translate-y-0.5 rounded-none">
                  Kontakt aufnehmen
