  ...
  return (
    <FastLoadWrapper>
      <Helmet>
        ...
        <meta
          name="description"
          content="New Edge automatisiert Geschäftsprozesse für mittelständische KMUs. Gewinnen Sie 30% mehr Zeit, steigern Sie Effizienz und werden Sie Vorreiter Ihrer Branche – mit KI-gestützten Tools und hybrider Expertise."
        />
        <meta
          name="keywords"
          content="KMU Automatisierung, Prozessoptimierung, Digitalisierung Mittelstand, KI für Unternehmen, Geschäftsprozesse automatisieren, Effizienzsteigerung, Innovation für KMUs"
        />
        <meta property="og:title" content="New Edge - Innovation & Automatisierung für mittelständische KMUs" />
        <meta
          property="og:description"
          content="Automatisierung und Innovation für KMUs: 30% mehr Zeit fürs Kerngeschäft, messbare Effizienzsteigerung, Vorreiter Ihrer Branche werden."
        />
      ...
      <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
        ...
        <section className="relative py-8 sm:py-12 bg-gradient-to-br from-white via-blue-50/20 to-white overflow-hidden">
          <div className="container-xl relative z-10">
            ...
            <motion.div
              className="grid md:grid-cols-2 gap-3 md:gap-4 items-stretch max-w-5xl mx-auto"
              initial="hidden"
              whileInView="visible"
              viewport={{
                once: true,
              ...
              {[
                {
                  ...
                  description:
                    "Wir automatisieren repetitive Aufgaben, damit Sie sich auf Ihr Kerngeschäft konzentrieren können.",
                ...
                },
                {
                  ...
                  description:
                    "Interdisziplinäres Team aus Strategen, Creatives und Entwicklern; alles aus einer Hand.",
                ...
                >
                  <motion.div
                    className={`bg-gradient-to-br ${point.gradient} backdrop-blur-sm p-3 md:p-6 rounded-xl md:rounded-2xl border ${point.border} shadow-lg h-full flex flex-col`}
                    whileHover={{
                      scale: 1.02,
                      y: -5,
                  ...
                  >
                    <div
                      className={`w-8 h-8 md:w-12 md:h-12 bg-gradient-to-br ${point.iconBg} rounded-lg md:rounded-xl flex items-center justify-center mb-2 md:mb-4`}
                    >
                ...
                >
                  <Card className="h-full bg-white border-border hover:border-primary/50 backdrop-blur-sm transition-all duration-500 hover:shadow-xl">
                    <CardContent className="p-4 md:p-8 flex flex-row md:flex-col items-start md:items-stretch gap-4 md:gap-0 h-full">
                      ...
                      <motion.div
                        className={`w-14 h-14 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-gradient-to-br ${service.gradient} flex items-center justify-center md:mb-6 shadow-lg flex-shrink-0`}
                        whileHover={{
                          scale: 1.1,
                          rotate: [0, -5, 5, 0],
                          transition: {
                      ...
                      <div className="flex-1 md:flex md:flex-col md:h-full">
                        ...
                        <Button
                          variant="default"
                          size="sm"
                          className="bg-primary hover:bg-primary/90 text-white group text-sm md:text-base md:mt-auto"
                          asChild
                        >
        ...
        <section
          id="contact-section"
          className="relative py-12 sm:py-16 bg-gradient-to-br from-primary/5 via-background to-primary/10"
        >
              ...
              <Card className="card-modern text-center p-3 sm:p-6 md:p-8 hover:shadow-xl transition-all flex flex-col">
                <CardContent className="space-y-3 sm:space-y-4 md:space-y-6 p-0 flex flex-col h-full">
                  ...
                  <div className="flex-grow">
                    <h3 className="text-sm sm:text-lg md:text-[28px] lg:text-[32px] font-medium mb-1 sm:mb-2 text-foreground leading-[1.3]">
                      Talk to Sales
                    </h3>
                  ...
                  <a
                    href="tel:+4915750998236"
                    className="text-primary font-semibold text-xs sm:text-base md:text-lg hover:underline mt-auto"
                  >
                    +49 157 5099 8236
                  </a>
                </CardContent>
              ...
              <Card className="card-modern text-center p-3 sm:p-6 md:p-8 hover:shadow-xl transition-all flex flex-col">
                <CardContent className="space-y-3 sm:space-y-4 md:space-y-6 p-0 flex flex-col h-full">
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-[10px] sm:text-sm md:text-base text-muted-foreground mb-2 sm:mb-3 md:mb-4 leading-[1.5]">
                      Sometimes you need a little help from your friends. Or a support rep. Don't worry... we're here
                      for you.
                    </p>
                  </div>
                  <Button
                    onClick={() => setIsContactSheetOpen(true)}
                    className="w-full bg-white border border-primary text-primary hover:bg-primary hover:text-white text-[10px] sm:text-sm md:text-base py-1 sm:py-2 mt-auto transition-all duration-300"
                  >
                    Contact Support
                  </Button>
                </CardContent>
