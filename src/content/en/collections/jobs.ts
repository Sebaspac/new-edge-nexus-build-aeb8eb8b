    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Consulting & needs analysis: leading first conversations, understanding requirements, positioning tailored solutions from Studio, Media & Lab",
    ...
    sections: [
      {
        ...
        items: [
          ...
          "Databases & integrations: Postgres & Supabase; working with REST, SQL, ETL",
          "Automations & scripts: n8n workflows, Supabase integrations, scripts (TypeScript)",
