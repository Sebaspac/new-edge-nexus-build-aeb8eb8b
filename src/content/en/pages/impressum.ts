...
export const impressum = {
  ...
  datenschutzSection: {
    ...
    cookies: {
      ...
      box: {
        title: "Your control",
        body: "Through our cookie settings you can individually decide which cookies you want to allow.",
      },
    },
    ...
    cookieConsent: {
      ...
      intro:
        "Since we use Meta Pixel, Google Tag Manager and Google Analytics, we use a cookie banner with an opt-in function.",
      box: {
        items: [
