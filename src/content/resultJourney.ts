...
export const resultJourneys: Record<string, ResultJourneyContent> = {
  ...
  auswahlverfahren: {
    ...
    steps: [
      ...
      { icon: IconTrendingDown, text: "Aus drei Monaten Verwaltung wird ein Verfahren, das läuft — bis zu 70% weniger Aufwand." },
    ],
  },
  ...
  entscheidungsinstanzen: {
    ...
    steps: [
      ...
      { icon: IconCircleCheck, text: "Aus wochenlanger Koordination wird ein Ergebnis, dem niemand widerspricht — bis zu 70% weniger Aufwand." },
    ],
  },
