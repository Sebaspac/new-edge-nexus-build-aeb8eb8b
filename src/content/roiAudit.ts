...
export const ROI_INDUSTRIES: RoiIndustry[] = [
  {
    ...
    useCases: [
      ...
      { nr: 35, prozess: "Material- & Lagerbestand", was: "Automatisches Tracking von Materialeinsatz je Auftrag mit Nachbestellungen bei Unterschreiten von Schwellenwert", tools: "Zapier + Google Sheets, Tradify, Handwerkercockpit", roiMin: 7680, roiMax: 14400, hours: 4, potential: 7, effort: 8, score: 6.6, quickWin: false },
  ...
  },
  {
    ...
    useCases: [
      ...
      { nr: 12, prozess: "Automatische Bewertung (AVM)", was: "KI generiert Marktpreisschätzungen für Kauf/Miete basierend auf Vergleichsdaten und Makrotrends", tools: "ImmobilienScout API, ChatGPT, Make.com", roiMin: 10000, roiMax: 30000, hours: 4, potential: 7, effort: 7, score: 6.3, quickWin: false },
    ],
  },
  {
    id: "architektur",
  ...
  },
  {
    ...
    useCases: [
      { nr: 26, prozess: "Digitale Patientenaufnahme", was: "Patienten füllen Anamnese & Versicherungsdaten digital vor Termin aus — Import direkt in Patientensystem", tools: "JotForm, Typeform, Make.com, Zapier", roiMin: 10400, roiMax: 15600, hours: 8, potential: 8, effort: 9, score: 8.6, quickWin: true },
      ...
      { nr: 30, prozess: "Ressourcen- & Raumplanung", was: "KI-gestützte Optimierung von Zeitslots, Raumbelegung und Personalschichten basierend auf Nachfragedaten", tools: "PowerBI, Python/ML, Google Cloud API, Zapier", roiMin: 5200, roiMax: 15600, hours: 2.5, potential: 7, effort: 7, score: 6.3, quickWin: false },
