  ...
  entscheidungsinstanzen: [
    {
      ...
      teaser:
        "70 % weniger Aufwand: Hunderte Bewerbungen werden automatisch erfasst, strukturiert und der Jury entscheidungsreif vorgelegt.",
      scenario:
      ...
      result:
        "70 % weniger Aufwand, 60 % höhere Jury-Effizienz — jede Entscheidung revisionssicher im Audit-Trail dokumentiert.",
      metrics: [
