    ...
    <section className={className}>
      ...
      <div className="relative max-w-[880px] mx-auto">
        <div className="flex items-center">
          ...
          <div className="pointer-events-none absolute inset-y-0 left-0 w-16 bg-gradient-to-r from-[var(--fade-color,#fafafa)] to-transparent" />
          <div className="pointer-events-none absolute inset-y-0 right-0 w-16 bg-gradient-to-l from-[var(--fade-color,#fafafa)] to-transparent" />
        </div>
      </div>
    </section>
  );
